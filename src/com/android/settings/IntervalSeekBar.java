...
public class IntervalSeekBar extends SeekBar {
    ...
    public IntervalSeekBar(Context context, AttributeSet attrs) {
        ...
        TypedArray seekBarType = context.obtainStyledAttributes(attrs,
                R.styleable.IntervalSeekBarAnim, 0, 0);

        mMax = seekBarType.getFloat(R.styleable.IntervalSeekBarAnim_maxI, 1.5f);
        mMin = seekBarType.getFloat(R.styleable.IntervalSeekBarAnim_minI, 0.5f);
        mDefault = seekBarType.getFloat(R.styleable.IntervalSeekBarAnim_defaultValuePure, 1.0f);

        int digits = seekBarType.getInt(R.styleable.IntervalSeekBarAnim_digits, 0);
